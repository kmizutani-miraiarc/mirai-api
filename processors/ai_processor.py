...
11. **建物/土地の種類の判定**: 登記地目や登記上の建物の種類も含めて、以下の候補から最も適切なものを選択してください（複数該当する場合はカンマ区切りで記載）：
...
- **登記関連情報の認識**: 以下のような表記を正確に認識してください：
  - 「地目：宅地」「登記地目：田」「現況地目：雑種地」
  - 「建物種類：居宅」「登記上の用途：共同住宅」「主たる用途：店舗」
  - 「家屋番号」「所在地番」「登記簿上の面積」
  - 「現況：駐車場として利用」「実際の用途：事務所」
- **和暦変換の詳細処理**:
...
{{
  ...
  "propertyLandType": "建物/土地の種類（例：居住用、事業用、投資用、住宅、店舗、事務所、工場、倉庫、駐車場、農地、宅地、山林など）",
